...
const messages = {
  en: {
    ...
    open: "Open note",
    openCalendar: "Open Link Calendar",
    openSettingsHelp: "Open Settings → Community plugins → Link Calendar.",
  ...
  ko: {
    ...
    open: "문서 열기",
    openCalendar: "Link Calendar 열기",
    openSettingsHelp: "설정 → 커뮤니티 플러그인 → Link Calendar를 여세요.",
    previous: "이전 달",
