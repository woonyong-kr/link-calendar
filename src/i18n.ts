...
const messages = {
  en: {
    ...
    people: "People",
    previewEmpty: "This note has no text preview.",
    previewLoading: "Loading note preview…",
    previewUnavailable: "The note preview could not be loaded.",
  ...
  ko: {
    ...
    people: "인물",
    previewEmpty: "미리 볼 본문이 없는 문서입니다.",
    previewLoading: "문서 미리보기를 불러오는 중…",
    previewUnavailable: "문서 미리보기를 불러오지 못했습니다.",
    previous: "이전 달",
    project: "프로젝트",
