...
const messages = {
  en: {
    ...
    automaticDateIndexDesc: "Index meaningful frontmatter and Markdown body dates across the Vault. Source notes stay unchanged.",
    ...
    temporalDocument: "Document date",
    temporalEvent: "Event",
  ...
  ko: {
    ...
    automaticDateIndexDesc: "Vault 전체의 의미 있는 frontmatter와 Markdown 본문 날짜를 자동으로 색인합니다. 원본 문서는 변경하지 않습니다.",
    calendarNotes: "일정 문서",
